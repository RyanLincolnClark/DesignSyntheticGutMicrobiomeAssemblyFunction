...
data = datasets["RLC8"]
posterior = load("2019_08_21_RLC3_posteriordata_set6.jld")
posterior["scale"]=1
...
outputpath = "../2019_08_21_output_RLC8_diagonal/lambda"*string(l)*"/"
...
args[:lambda]=l
opts[:guesspath]="../2019_08_21_output_RLC8_diagonal/lambda500/guess2/lambda500_guess2_"
