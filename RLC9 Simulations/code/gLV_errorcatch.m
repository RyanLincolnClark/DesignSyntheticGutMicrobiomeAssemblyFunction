function output = gLV(t,x,params)
    ...
    a=params(2:n+1,:); %This pulls the aij matrix out of the parameter matrix. I removed the transpose because the output from the fmincon process is transposed.
    for i=1:n
