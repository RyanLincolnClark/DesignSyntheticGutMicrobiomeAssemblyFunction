...
csvwrite("2019_08_21_ensemble_RLC3.csv",ensemble);
csvwrite("2019_08_21_covmat_diagonal_RLC3.csv",covmat);
csvwrite("2019_08_21_invcovmat_diagonal_RLC3.csv",invcovmat);
csvwrite("2019_08_21_priormeans_RLC3.csv",meanparams);
csvwrite("2019_08_21_priorperturbations_diagonal_RLC3.csv",perturbations);