...
data = datasets["RLC3"]
posterior = load("2019_08_20_RLC2_posteriordata_diagonal.jld")
posterior["scale"]=1
...
outputpath = "../2019_08_18_output_RLC3_diagonal/lambda"*string(l)*"/"
...
args[:lambda]=l
opts[:guesspath]="../2019_08_18_output_RLC3_diagonal/lambda100/guess203/lambda100_guess203_"

#Load the best guess
load_param_guess(opts,args)

# Save the output ----------------
inference_analysis(data,args,opts,posterior,2000)