...
for initialguess=400:450

for l in lambdas
outputpath = "../2019_08_18_output_RLC3_diagonal/lambda"*string(l)*"/guess"*string(initialguess)*"/lambda"*string(l)*"_guess"*string(initialguess)*"_"
